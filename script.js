...
function drawWoWChart() {
  ...
  // Prior week (13 Jul 2026) vs this week (20 Jul 2026)
  var metrics = [
    { label: 'Bugaboo Trustpilot ★',     prev: 4.00,  curr: 4.00  },
    { label: 'Bugaboo Reviews (×100)',   prev: 26.00, curr: 26.14 },
    { label: 'Bugaboo Sentiment',        prev: 0.65,  curr: 0.68  },
    { label: 'Joolz Trustpilot ★',      prev: 3.10,  curr: 3.10  },
    { label: 'Joolz Reviews (×100)',     prev: 9.99,  curr: 10.40 },
    { label: 'Joolz Sentiment',          prev: 0.20,  curr: 0.18  },
    { label: 'Artipoppe Sentiment',      prev: 0.17,  curr: 0.15  },
  ];
  ...
  charts.compare = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [
        ...
        { label: 'Sentiment Score', data: [0.68, 0.18, 0.15], backgroundColor: ['#e63946aa', '#6366f1aa', '#f59e0baa'], borderColor: ['#e63946', '#6366f1', '#f59e0b'], borderWidth: 2, borderRadius: 4, yAxisID: 'y2' }
      ]
    },
    options: {
  ...
  charts.compStroller = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: [0.68, null, 0.65, 0.60, 0.38, 0.57, 0.45, 0.18],
...
function drawCompCarrierChart() {
  ...
  charts.compCarrier = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        label: 'Sentiment Score',
        data: [0.75, 0.72, 0.70, 0.65, 0.48, 0.15],
